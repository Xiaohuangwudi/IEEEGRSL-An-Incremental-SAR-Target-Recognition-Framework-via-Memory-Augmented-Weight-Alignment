...
from convs.resnet import resnet18, resnet34, resnet50, resnet101, resnet18_mem
...
def get_convnet(args, pretrained=False):
    ...
    elif name == "resnet18_mem":
        return resnet18_mem(pretrained=pretrained,args=args)
...
class IncrementalNet(BaseNet):
    ...
    def weight_align(self, increment):
        ...
        if hasattr(self.convnet, 'mem') and self.convnet.mem is not None:
            print("weight_align, convnet.mem is not None")
            self.convnet.mem.eval() 
            refined_weights, _ = self.convnet.mem(weights)
